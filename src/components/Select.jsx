...
function Select() {
  ...
  return (
    <div className="flex justify-between mt-16 px-16">
      <p className='absolute top-40 font-bold'>Amount</p>
      <input
        type="number"
        placeholder="Amount to convert..."
        className="input input-bordered w-72 p-3 max-h-12 bg-slate-50 rounded-md max-w-xs border-2"
        value={amount}
      ...
      <div>
        ...
        >
          {selectedFrom && !openFromOptions && (
            <div onClick={() => setOpenFromOptions(!openFromOptions)} className='flex items-center gap-4'>
      ...
      <div>
        ...
        >
          {selectedTo && !openToOptions && (
            <div onClick={() => setOpenToOptions(!openToOptions)} className='flex items-center gap-4'>
      ...
      <button onClick={handleConvert} className="convert absolute top-[480px] right-[260px] bg-white font-semibold border-2 p-4 rounded-md">
        Convert
      </button>
